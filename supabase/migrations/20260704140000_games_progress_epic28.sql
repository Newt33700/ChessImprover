...
ALTER TABLE games ADD COLUMN IF NOT EXISTS progress_current INT NOT NULL DEFAULT 0;
ALTER TABLE games ADD COLUMN IF NOT EXISTS progress_total INT NOT NULL DEFAULT 0;
